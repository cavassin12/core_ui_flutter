...
/// Posição da barra de abas em relação ao conteúdo, equivalente ao
/// `TabEdge` do pacote `tab_container`.
enum TabContainerBorda { superior, inferior, esquerda, direita }
